...
{ 
  ...
  {
    await FirebaseFirestore.instance.collection("user").doc(currentUserID).get().then((snapshot)
    {
      setState(() {
        ...
        employmentTextEditingController.text = employmentStatus;
  ...
  Widget build(BuildContext context) 
  {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          next ? "Profile Information" : "Choose 5 Imamges",
